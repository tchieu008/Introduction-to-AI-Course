...
graph = pydot.Dot(graph_type='graph',strict=False, bgcolor="#fff3af",
                  ...
                  fontcolor="yellow", fontsize="24", overlap="true")
# To track node
i = 0
...
depth_value = args.get("depth", 20)
if depth_value is not None:
    max_depth = int(depth_value)
else:
    # Xử lý khi không tìm thấy khóa "depth"
    max_depth = 20  # Giá trị mặc định
